...
namespace
{
	...
	void FindIntersectionBoxSphere(Box * box, Sphere * sphere, std::vector<Intersection> & intersections)
	{
		...
		if(distSq < r*r+1e-4f)
		{
			...
			intersections.push_back(Intersection(box, sphere, p, v));
		}
	}
